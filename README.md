...
## POLYBOT V2 Project Context

Future Codex and coding-agent work should start with:

- [AGENTS.md](AGENTS.md)
- [docs/POLYBOT_CONTEXT_INDEX.md](docs/POLYBOT_CONTEXT_INDEX.md)
- [docs/POLYBOT_V2_MASTER_CONTEXT.md](docs/POLYBOT_V2_MASTER_CONTEXT.md)
- [docs/POLYBOT_V2_ROADMAP.md](docs/POLYBOT_V2_ROADMAP.md)
