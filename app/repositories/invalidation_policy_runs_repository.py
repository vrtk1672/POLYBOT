...
class InvalidationPolicyRunsRepository:
    def open_run(self, conn: Connection, run: InvalidationPolicyRunOpenContract) -> None:
        conn.execute(
            """
    ...
    def close_run(self, conn: Connection, run: InvalidationPolicyRunCloseContract) -> None:
        conn.execute(
            """
            UPDATE invalidation_policy_runs
            SET status = %s,
                ended_at = %s,
                success_count = %s,
                failure_count = %s,
