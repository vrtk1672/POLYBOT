...
def test_producer_health_does_not_create_orders_or_enable_paper(postgres_test_schema) -> None:
    before = {
    ...
    payload = ProducerHealthService().get_producer_health_summary(limit=20)
...
def test_producer_health_does_not_create_order_intents(postgres_test_schema) -> None:
